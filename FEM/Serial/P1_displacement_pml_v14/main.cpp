...
int main(void)
{
    ...
    for (int it = 0; it < Ntime; it++) {
        ...
        //   复坐标拉伸 1/s = 1 - d/(iω+d)，拉伸后内力 = K·u - F_ψ，移到右端
        //   b = f - C·v_pred - (K·u - F_ψ) = ... + F_ψ。
        //   （SESSION 14 修正：此前为 -F_ψ，符号反了，反而比纯海绵层更差。）
        //   F_ψ 只进 b、不碰 A → A 仍对称正定，CIM 不受影响。
